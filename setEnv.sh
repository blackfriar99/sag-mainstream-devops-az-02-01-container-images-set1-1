...
export MY_AZ_ACR_URL=${MY_AZ_ACR_URL:-"azdevopspj1acr.azurecr.io"}
...
export SUIF_HOME_URL="https://raw.githubusercontent.com/blackfriar99/sag-unattended-installations/${JOB_SUIF_TAG}"
